...
/*
    ...
    */
      ...
      import {  validateLogin, setUser, getUser } from "../data-manager/users-data-method.js";
      let codeMsg = "aca";
      let opCodesErr = {
        ...
        let setUserValidator = {
          ...
          mobile: { 
            presence: false,  // Mobile is optional in this case, as per your original code
            type: "string"
          },
          username: { 
            presence: { allowEmpty: false },
            type: "string",
            format: regExConstants.username  // Validate the username format
          },
          password: { 
            presence: { allowEmpty: false },
            type: "string",
            format: regExConstants.password  // Validate the password format
          }
        };
        const check = async a => {
          ...
          if (!["validateLogin", "createUser",].includes(a.$$.op)) {
        ...
        let entityValidator = null;
          ...
          if (op === "validateLogin" ||  op === "createUser") {
        ...
        const auth_service = async (req, res) => {
        ...
        export default { auth_service, _users };
